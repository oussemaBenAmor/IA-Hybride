...
def init_db():
    ...
    try:
        with conn.cursor() as cur:
            ...
            # ── Rattachement d'une conversation à un utilisateur + titre ──
            # (colonnes ajoutées si elles n'existent pas déjà)
            cur.execute("""
            ...
            # ── Messages persistés (pour recharger une conversation) ──────
            cur.execute("""
