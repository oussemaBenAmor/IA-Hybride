...
class TestExtractRules:
    """Vérifie la lecture de la clé camelCase renvoyée par Java."""
...
# ══════════════════════════════════════════════════════════════════════════════
# odm_call_node : cas de SUCCÈS (Spring répond une décision)
# ══════════════════════════════════════════════════════════════════════════════
...
class TestOdmIndisponible:
    ...
    def test_retry_error_donne_fallback_e(self, mocker):
        # Simule l'échec après tous les retries (ODM injoignable)
    ...
    def test_erreur_inattendue_donne_fallback_e(self, mocker):
        # Une exception quelconque → aussi Fallback E (robustesse)
        mocker.patch(
            "app.graph.nodes.odm_call._call_odm",
